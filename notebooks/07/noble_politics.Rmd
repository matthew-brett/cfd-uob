...
<meta property="og:url" content="https://matthew-brett.github.io/cfd-uob/notebooks/07/noble_politics.Rmd">
...
<link rel="canonical" href="https://matthew-brett.github.io/cfd-uob/notebooks/07/noble_politics.Rmd">
...
* to practice and extend [Pandas indexing](/cfd-uob/chapters/07/pandas_indexing);
...
[oliner_tab6_8a_1.csv](/cfd-uob/data/oliner_tab6_8a_1.csv) to the same directory as this notebook.
...
We have already seen [Pandas indexing](/cfd-uob/chapters/07/pandas_indexing).   We are going to be selecting data out of this table with indexing, and we would like to make the index (row labels) be as informative as possible.  The current index, which Pandas created automatically, is sequential numbers, which are not memorable or informative.
