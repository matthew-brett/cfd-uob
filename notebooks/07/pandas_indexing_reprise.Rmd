...
<meta property="og:url" content="https://matthew-brett.github.io/cfd-uob/notebooks/07/pandas_indexing_reprise.Rmd">
...
<link rel="canonical" href="https://matthew-brett.github.io/cfd-uob/notebooks/07/pandas_indexing_reprise.Rmd">
...
You have already seen the [basics of Pandas indexing](/cfd-uob/chapters/07/pandas_indexing); this page is just a reminder of the later
...
page](/cfd-uob/data/rate_my_professors) for more detail.
...
As you have seen in the [Pandas indexing page](/cfd-uob/chapters/07/pandas_indexing), the examples above are the two types of safe
...
complicated.  See [Booleans and labels](/cfd-uob/chapters/07/booleans_and_labels) for more detail.
