...
<meta property="og:url" content="https://matthew-brett.github.io/cfd-uob/notebooks/02/Expressions.Rmd">
...
<link rel="canonical" href="https://matthew-brett.github.io/cfd-uob/notebooks/02/Expressions.Rmd">
...
* adds the CR of 3 and the CR of 4 to get a CR of 7.

The CR of 7 is the value returned from the expression.  The notebook turns that
into something that humans can read easily - the HR of 7 - which is `7`.
...
![Washington Post graph](/cfd-uob/images/bad_post_graph.png)
...
![Ross Ihaka's version of Post graph](/cfd-uob/images/ihaka_fixed_post_graph.png)
