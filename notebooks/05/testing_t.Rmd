...
<meta property="og:url" content="https://matthew-brett.github.io/cfd-uob/notebooks/05/testing_t.Rmd">
...
<link rel="canonical" href="https://matthew-brett.github.io/cfd-uob/notebooks/05/testing_t.Rmd">
...
For example, in the [permutation and t-test page](/cfd-uob/chapters/05/permutation_and_t_test), we asserted that the t-test is not
...
more details on the dataset, and [the data license page](/cfd-uob/data/license).
...
We can pull together the code in [permutation and t-test page](/cfd-uob/chapters/05/permutation_and_t_test) to implement our own t-test.
...
t-test page](/cfd-uob/chapters/05/permutation_and_t_test):
...
[permtuation and t-test page](/cfd-uob/chapters/05/permutation_and_t_test).
