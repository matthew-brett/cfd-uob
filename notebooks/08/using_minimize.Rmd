...
<meta property="og:url" content="https://matthew-brett.github.io/cfd-uob/notebooks/08/using_minimize.Rmd">
...
<link rel="canonical" href="https://matthew-brett.github.io/cfd-uob/notebooks/08/using_minimize.Rmd">
...
We used the [students ratings dataset](/cfd-uob/data/rate_my_professors) dataset.  Download the data file via
[disciplines_SI.xlsx](/cfd-uob/data/disciplines_SI.xlsx).
...
We pass the function to `minimize` as an argument for it to use.  Try the [functions as values exercise](/cfd-uob/exercises/function_vals.zip) for more practice on the idea of using functions as values like this.
...
[calling](/cfd-uob/02/Calls) the function, but what arguments is it
