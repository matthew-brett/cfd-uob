...
<!-- begin _includes/seo.html --><title>Coding for Data - 2020 edition</title>
...
<meta property="og:url" content="https://matthew-brett.github.io/cfd-uob/notebooks/10/bayes_confidence.Rmd">
...
<link rel="canonical" href="https://matthew-brett.github.io/cfd-uob/notebooks/10/bayes_confidence.Rmd">
    ...
    <div class="masthead__menu">
      <nav id="site-nav" class="greedy-nav">
        ...
        <ul class="visible-links">
            ...
            <li class="masthead__menu-item">
              <a href="https://uobhub.org">uobhub</a>
            </li>
  ...
  <article class="page" itemscope itemtype="http://schema.org/CreativeWork">
    ...
    <div class="page__inner-wrap">
      ...
      <section class="page__content" itemprop="text">
        ...
        In the [problem for the education minister](/cfd-uob/chapters/10/havana_math) we had a sample of fast-track-marked exams from
...
After a bit of development, we found, in the [reverse probability with bars](/cfd-uob/chapters/10/bayes_bars) page, that we could use some
...
As we saw in the page on [using minimize](/cfd-uob/chapters/08/using_minimize#unpacking), we can get this value a little more
...
Look back at [where and argmin](/cfd-uob/chapters/08/where_and_argmin) for this trick of using `np.where` to find the
index.
    ...
    if (hubUrl !== undefined) {
      ...
      if (link !== undefined) {
          ...
          if ('jupyterhub' == 'binder') {
            ...
            href = href.replace("https://uobhub.org", hubUrl);
          }
